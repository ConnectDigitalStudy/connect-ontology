 CONNECT Ontology Structure

## Introduction

The CONNECT ontology defines the structure of data collected in the CONNECT study. It organizes data from participants, devices, and measurements into a formal structure for easy integration and reasoning.
...
The ontology defines several properties that establish relationships between the classes:
